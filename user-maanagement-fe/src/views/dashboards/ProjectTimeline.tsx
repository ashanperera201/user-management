...
const labels = ['Seasons X completed', 'Seasons X completed', 'Seasons X completed', 'Seasons X completed', 'Seasons X completed']
      ...
      <Grid container>
        <StyledGrid item xs={12} sm={8}>
          <CardHeader
            ...
            subheader='Total 840 streams Completed'
          ...
          <CardContent>
            <Box sx={{ mb: 6, display: 'flex', alignItems: 'center' }}>
              ...
              <Box sx={{ display: 'flex', flexDirection: 'column' }}>
                ...
                <Typography variant='caption'>live users 2.5k</Typography>
              </Box>
            </Box>
            <Box sx={{ mb: 6, display: 'flex', alignItems: 'center' }}>
