...
const Register = () => {
  ...
  const { control, handleSubmit, formState: { errors } } = useForm({ defaultValues, mode: 'onChange', resolver: yupResolver(schema) });

  const onSubmit = (data: FormData) => {
    const { email, firstName, lastName, userName, password } = data

    register({ email, firstName, lastName, userName, password }, err => {
