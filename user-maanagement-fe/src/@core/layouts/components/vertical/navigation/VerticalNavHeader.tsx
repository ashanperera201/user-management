  ...
  return (
    <MenuHeaderWrapper className='nav-header' sx={{ pl: menuHeaderPaddingLeft() }}>
      {userVerticalNavMenuBranding ? (
        ...
        <Link href='/' passHref>
          <StyledLink>
            <svg id="logo" xmlns="http://www.w3.org/2000/svg" width={40} height={22} viewBox="0 0 189.747 59.545">
              <path id="Triangle" d="M24.235,2.72a4.86,4.86,0,0,1,8.728,0L56.676,50.555a4.919,4.919,0,0,1-4.364,7.122H4.885A4.919,4.919,0,0,1,.521,50.555Z" transform="translate(0 1.371)" fill="#fff" />
              <path id="Triangle_Copy_2" data-name="Triangle Copy 2" d="M24.235,2.72a4.86,4.86,0,0,1,8.728,0L56.675,50.555a4.919,4.919,0,0,1-4.363,7.122H4.885A4.919,4.919,0,0,1,.521,50.555Z" transform="translate(88.366 1.371)" fill="#fff" />
              <path id="Subtract" d="M0,0,26.965,54.393a6.944,6.944,0,0,0,12.468,0L66.4,0H57.047L33.2,48.106,9.351,0Z" transform="translate(39.583 1.265)" fill={theme.palette.primary.main} />
              <path id="Triangle_Copy_3" data-name="Triangle Copy 3" d="M24.236,54.956a4.859,4.859,0,0,0,8.726,0L56.676,7.122A4.92,4.92,0,0,0,52.312,0H4.885A4.919,4.919,0,0,0,.521,7.122Z" transform="translate(132.549)" fill="#fff" />
            </svg>
